      ...
      <div className="w-full h-screen flex flex-col justify-between items-center px-3 box-border pt-16">
        <form className="flex flex-col w-full sm:w-96 2xl:w-1/3 box-border">
          ...
          <Link href="/profile/signup">
            <a className="text-purple-600 font-semibold text-xs py-3 cursor-pointer">
              아이디가 없으신가요?
            </a>
          </Link>
          <Button text="로그인" bgcolor="bg-slate-200" large={true}></Button>
        </form>
        <div className="sm:w-96 2xl:w-1/3 h-1/3 flex flex-col justify-center text-xs md:text-base">
          <span>
          ...
          <span className="cursor-pointer pt-4 font-semibold text-purple-600">
