...
const Enter: NextPage = () => {
  return (
    <div className="bg-purple-600 w-full h-screen text-3xl font-semibold items-center flex flex-col justify-center gap-y-5">
      <div className="overflow-hidden relative grid grid-cols-4 gap-1 ">
      ...
      <div className="min-w-min max-w-md">
        <span>Twitch는 항상 새로운 방송으로 가득해요</span>
        <div className="gap-3 flex my-12 mx-2">
